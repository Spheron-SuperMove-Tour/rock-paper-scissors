      ...
      <div className="h-screen flex justify-center align-middle">
        <div className="my-auto w-4/5">
          <div className="flex justify-center">
            <button className="bg-green-500 mx-auto px-6 py-2 rounded-xl text-white my-2">
              Start Game
            </button>
          </div>
          <div className=" p-5">
            <div className="flex gap-2">
              ...
              <div className="bg-white w-1/2 rounded-2xl p-5">
                ...
                <div className="flex gap-2">
                  <button className="bg-red-300 mx-auto px-8 py-4 text-xl rounded-xl my-2">
                    Clear
                  </button>
                  <button className="bg-orange-300 mx-auto px-8 py-4 text-xl rounded-xl my-2">
                    Rock
                  </button>
                  <button className="bg-orange-300 mx-auto px-8 py-4 text-xl rounded-xl my-2">
                    Paper
